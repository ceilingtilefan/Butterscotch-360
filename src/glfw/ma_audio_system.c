...
static void maSetChannelCount(UNUSED AudioSystem* audio, UNUSED int32_t count) {
    // miniaudio handles channel management internally, this is a no-op
}

static void maGroupLoad(UNUSED AudioSystem* audio, UNUSED int32_t groupIndex) {
...
static bool maGroupIsLoaded(UNUSED AudioSystem* audio, UNUSED int32_t groupIndex) {
